...
def build_fact_orders(orders: DataFrame, customers: DataFrame, products: DataFrame) -> DataFrame:
    return (
        orders.withColumn("date_key", F.date_format("order_timestamp", "yyyyMMdd").cast("int"))
        .alias("o")
